...
The storage format is Parquet, one file per day, with SNAPPY compression.  Files are hosted on S3, with the naming convention:
  ...
  - `s3://anaconda-package-data/conda/monthly/[year]/[year]-[month].parquet`
